...
项目采用 **领域驱动设计（DDD）** 架构模式，按业务领域划分模块：

```
comfy-pilot-backend/
├── src/main/java/org/joker/comfypilot/
│   ├── ComfyPilotBackendApplication.java    # 应用启动类
│   │
│   ├── common/                               # 公共模块
│   │   ├── application/                      # 应用层
│   │   │   └── dto/                          # 数据传输对象
...
│       ├── user/                             # 用户模块 Mapper
│       ├── comfyui/                          # ComfyUI 模块 Mapper
│       ├── workflow/                         # 工作流模块 Mapper
│       ├── session/                          # 会话模块 Mapper
│       ├── agent/                            # Agent 模块 Mapper
│       ├── model/                            # 模型模块 Mapper
│       └── resource/                         # 资源模块 Mapper
│
├── docs/                                     # 文档目录
│   ├── requirements/                         # 需求文档
│   │   ├── README.md                         # 需求文档索引
│   │   ├── 00-项目概述.md                    # 项目概述
│   │   ├── 01-核心数据模型.md                # 数据模型设计
│   │   ├── 02-API设计.md                     # API 接口设计
│   │   ├── 03-用户模块.md                    # 用户模块需求
│   │   ├── 04-服务模块.md                    # 服务模块需求
│   │   ├── 05-工作流模块.md                  # 工作流模块需求
│   │   ├── 06-会话模块.md                    # 会话模块需求
│   │   ├── 07-Agent模块.md                   # Agent 模块需求
│   │   ├── 08-AI模型模块.md                  # AI 模型模块需求
│   │   ├── 09-资源模块.md                    # 资源模块需求
│   │   └── 99-技术规范.md                    # 技术规范
│   ├── api/                                  # API 文档
│   │   ├── 01-用户模块API.md
...
│   └── architecture/                         # 架构文档
│       ├── DDD架构说明.md                    # DDD 架构说明
│       ├── Redis配置说明.md                  # Redis 配置说明
│       ├── TraceId日志追踪系统使用说明.md    # TraceId 使用说明
│       └── 实体基类使用说明.md               # 实体基类说明
│
└── pom.xml                                   # Maven 配置文件
```
