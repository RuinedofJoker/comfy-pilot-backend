...
[--disable-auto-launch] [--cuda-device DEVICE_ID] [--default-device DEFAULT_DEVICE_ID]
...
[--disable-ipex-optimize] [--supports-fp8-compute] [--preview-method [none,auto,latent2rgb,taesd]]
...
Set the id of the cuda device this instance will use. All other devices will not be visible.
...
--cache-ram [CACHE_RAM]
Use RAM pressure caching with the specified headroom threshold. If available RAM drops below
the threhold the cache remove large items to free RAM. Default 4GB
...
Enables the legacy UI of ComfyUI-Manager
