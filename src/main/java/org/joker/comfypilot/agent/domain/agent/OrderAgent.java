...
public class OrderAgent {
    ...
    private static final String HELP = """
            ...
            我是 ComfyUI 工作流编辑对话助手，可以帮助你创建、修改和优化 ComfyUI 工作流。
            ...
            ──────────────────────────────────────────────
              ...
              /help     显示此帮助信息
              /clear    清空当前会话的所有对话历史和 Token 使用统计
              /compact  压缩对话历史为摘要，节省 Token 并保留关键信息
            ...
            【工作流操作】
              • 直接描述你想要的工作流功能，我会帮你创建或修改工作流
              • 可以上传图片、视频等多模态内容作为参考
              • 我可以查看和修改你当前的工作流，并在页面上实时展示
            
            【服务管理】
              • 我可以检查 ComfyUI 服务状态、查看队列、管理模型
              • 如果配置了高级功能，我还能执行终端命令和 Python 脚本
            
            【会话管理】
              • 当对话历史过长时，系统会自动触发摘要
              • 你也可以主动使用 /compact 压缩历史，或使用 /clear 清空重新开始
            
            ──────────────────────────────────────────────
            使用提示
            ──────────────────────────────────────────────
            
              • 描述需求时尽量具体，包括输入输出、模型选择、参数配置等
              • 遇到问题可以直接告诉我错误信息，我会帮你排查和修复
              • 我会使用各种工具（包括 Skills、文档阅读等）来完成任务
