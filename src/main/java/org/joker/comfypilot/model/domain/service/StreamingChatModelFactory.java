...
/**
 * StreamingChatModel 工厂接口
 * <p>
 * 根据模型配置和提供商信息创建 LangChain4j 的 StreamingChatModel 实例。
 ...
 * StreamingChatModel chatModel = factory.createStreamingChatModel(model, provider);
 *
 * // 使用模型
 * chatModel.generate("Hello", response -> {
...
public interface StreamingChatModelFactory {
     ...
     * <p>
     * 根据模型的接入方式和提供商类型创建对应的 StreamingChatModel：
     * <ul>
